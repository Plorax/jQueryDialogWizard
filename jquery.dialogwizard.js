 ...
 (function (window, document, $, undefined) {
   ...
   Plugin.prototype = {
     ...
     show: function (internal = false) {
       ...
       if (!internal) {
         $("div[aria-describedby='" + this.dialog_id + "']").css(
           "opacity",
           "0"
         );
       } else {
       ...
       this.prepareScripts({ dialog_id: this.dialog_id });
     ...
     blinkElement: function (
       element,
       blink_color = { r: 255, g: 255, b: 255 }
     ) {
       let position = $(element).position();
       let size = {
     ...
     validateForm: function () {
       ...
       if (errors.length > 0) {
         ...
         $("#" + this.dialog_id + " button[type=submit]").removeProp(
           "disabled"
         );
         return false;
       }
     ...
     $("a[data-dw='toggle']").each(function () {
       ...
       if (!alreadySetup) {
         ...
         $(hreftarget).on("click", function (event) {
           ...
           let html = $(
             "div[id='" + target_id + "'][data-dw='dialogX']"
           ).html();
           ...
           if (
             get_field_values_url != undefined &&
             get_field_values_url != ""
           ) {
             let $this = this;
             $.ajax({
   ...
   $.fn[NAMESPACE].defaults = {
     ...
     apply_styles: function () {
       let styles =
         this.ops.dialog_styles != null ? this.ops.dialog_styles : {};
